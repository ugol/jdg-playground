...
public class Node1 extends JDGNode {

    private static final long ENTRY_LIFESPAN = 60 * 1000; // 60 seconds
    //private Logger log = Logger.getLogger(this.getClass().getName());
    private Logger log = Logger.getLogger("it.redhat.bankit.Node1");
    ...
    public static void main(String[] args) {
        ...
        Cache<Object, Object> cacheManager = new DefaultCacheManager().getCache();
        log.info(cacheManager.getCacheConfiguration().toString());
        cacheManager.put("1", "ugol");
        log.info("Cache size: " + cacheManager.size());
        log.info("" + cacheManager.containsKey("1"));
